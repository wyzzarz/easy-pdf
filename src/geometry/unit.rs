...
impl Add for &Unit {
    ...
    fn add(self, rhs: Self) -> Unit {
        match self {
            Unit::Cm(_) => Unit::Cm(self.decimal_value() + rhs.cm().decimal_value()),
            Unit::Pixel(_) => Unit::Pixel(self.decimal_value() + rhs.pixel().decimal_value()),
            Unit::Point(_) => Unit::Point(self.decimal_value() + rhs.point().decimal_value()),
            Unit::Inch(_) => Unit::Inch(self.decimal_value() + rhs.inch().decimal_value()),
            Unit::Mil(_) => Unit::Mil(self.decimal_value() + rhs.mil().decimal_value()),
            Unit::Mm(_) => Unit::Mm(self.decimal_value() + rhs.mm().decimal_value()),
        }
    }
...
impl Mul for &Unit {
    ...
    fn mul(self, rhs: Self) -> Unit {
        match self {
            Unit::Cm(_) => Unit::Cm(self.decimal_value() * rhs.decimal_value()),
            Unit::Pixel(_) => Unit::Pixel(self.decimal_value() * rhs.decimal_value()),
            Unit::Point(_) => Unit::Point(self.decimal_value() * rhs.decimal_value()),
            Unit::Inch(_) => Unit::Inch(self.decimal_value() * rhs.decimal_value()),
            Unit::Mil(_) => Unit::Mil(self.decimal_value() * rhs.decimal_value()),
            Unit::Mm(_) => Unit::Mm(self.decimal_value() * rhs.decimal_value()),
        }
    }
...
impl Unit {
    ...
    /// Creates a new `Point` with a zero value.
    pub fn zero() -> Self {
        Unit::default()
    }
